...
urlpatterns = [
    ...
    # path('api/<int:id>/',views.EmployeeUpdateView.as_view())
    # path('api/<int:id>/',views.EmployeeDestroyView.as_view())
     path('api/',views.EmployeeListCreateAPIView.as_view()),
    path('api/<int:id>/',views.EmployeeListRetrieveUpdateDestroyAPIView.as_view())
